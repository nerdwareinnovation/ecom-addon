    ...
    <div class="page-content">
      <div class="container skeleton-body">
        <div class="product-details-top">
          <div
            class="row skel-pro-single masonry_sticky"
            :class="{ loaded: loaded }"
          >
            <div class="col-md-6">
...
// Access the route and demo store
const route = useRoute();
const demoStore = useDemoStore();

// Computed property for current demo
...
// Handle sticky behavior based on screen size
const stickyHandle = () => {
  shouldSticky.value = window.innerWidth > 991;
};
