    ...
    <div class="page-content">
              ...
              <td class="price-col">
                ...
                <template v-else>
                  ...
                  <template v-else>
                    ...
                    <div class="product-price d-inline-block mb-0" v-else>
      ...
      <div class="container" v-else key="noWishlist">
        <div class="text-center">
          ...
          <nuxt-link to="/shop/sidebar/list" class="btn btn-primary mt-2"
            >Go Shop</nuxt-link
          >
        </div>
      </div>
