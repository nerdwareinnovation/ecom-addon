<template>
  <main class="main">
    <page-header title="Testimonials" subtitle="Elements"></page-header>
    ...
    <div class="page-content">
              ...
              <div class="swiper-slide">
                <blockquote class="testimonial testimonial-icon text-center">
                  <p>
                    “ Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                    Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In
                    nisi neque, aliquet vel, dapibus id, mattis vel, nisi tortor
      ...
      >
        <div class="container">
          ...
          <div
            class="swiper-carousel swiper-testimonials swiper-light swiper-4"
          >
            <div v-swiper:swiper4="carouselSetting4">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <blockquote
                    class="testimonial testimonial-icon text-center text-white"
                  >
                    <p>
      ...
      <div class="container">
        ...
        <div class="swiper-carousel swiper-testimonials-photo">
          <div
            class="swiper-carousel swiper-testimonials swiper-light swiper-5"
          >
