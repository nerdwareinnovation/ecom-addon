    ...
    <ul class="menu sf-arrows">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <ul>
                      ...
                      <li>
                        <nuxt-link to="/shop/nosidebar/fullwidth"
                  ...
                  <div class="col-md-6">
                    ...
                    <ul>
                      <li>
                        <nuxt-link to="/shop/category/boxed"
            ...
            <div class="col-md-6">
              <div class="menu-col">
                ...
                <ul>
                  ...
                  <li>
                    <nuxt-link to="/product/gallery/beige-metal-hoop-tote-bag"
                      >Gallery</nuxt-link
                    >
                  </li>
                  <li>
                    <nuxt-link to="/product/sticky/brown-faux-fur-longline-coat"
                  ...
                  <li>
                    <nuxt-link to="/product/masonry/black-denim-dungaree-dress"
      ...
      <li :class="{ active: current == 'blog' }">
        ...
        <ul>
          ...
          <li>
            <nuxt-link to="/blog/masonry/masonry-2" class="sf-with-ul"
              >Masonry</nuxt-link
            >
            <ul>
              <li>
